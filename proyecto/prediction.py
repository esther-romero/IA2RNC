...
def predict(file):
    ...
    # Array de dos dimensiones [[0,0...0]] donde la primer dimension contiene la cantidad de clases en el modelo
    array = cnn.predict(x)
    # La prediccion arrojara como resultado un 1 en la clase correspondiente
    # La dimension 0 es la que incluye las clases del modelo entrenado
    result = array[0]
    # Obtiene el indice del elemento que tiene el valor mas alto
