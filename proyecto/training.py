...
cnn.add(Convolution2D(filtrosConv1, tamano_filtro1, padding="same", input_shape=(
    longitud, altura, 3), activation='relu'))  # Definicion de la primer capa de convolucion
# Defincion de la primera capa de MaxPooling
cnn.add(MaxPooling2D(pool_size=tamano_pool))

# Definicion de la segunda capa de convolucion
cnn.add(Convolution2D(filtrosConv2, tamano_filtro2, padding="same"))
# Defincion de la segunda capa de MaxPooling
cnn.add(MaxPooling2D(pool_size=tamano_pool))
...
# Segunda capa densa y ultima capa de la red
...
Y_pred = cnn.predict_generator(
    validacion_generador, num_of_test_samples // batch_size+1)
...
print(classification_report(validacion_generador.classes,
